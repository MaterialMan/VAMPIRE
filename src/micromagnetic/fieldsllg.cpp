...
namespace micromagnetic{
   ...
   namespace internal{
      ...
      //Sum H = H_exch + H_A +H_exch_grains +H_App + H+dip   *******reservoir input applied at z
      spin_field[0] = ext_field[0] + exchange_field[0] - one_o_chi_perp[cell]*m[0]*m_e[cell]*ku_x[cell]  + sigma_para*mtrandom::gaussian() + pinning_field_x[cell] + reservoir::input_field[cell][0];
      spin_field[1] = ext_field[1] + exchange_field[1] - one_o_chi_perp[cell]*m[1]*m_e[cell]*ku_y[cell]  + sigma_para*mtrandom::gaussian() + pinning_field_y[cell] + reservoir::input_field[cell][1];
      spin_field[2] = ext_field[2] + exchange_field[2] - one_o_chi_perp[cell]*m[2]*m_e[cell]*ku_z[cell]  + sigma_para*mtrandom::gaussian() + pinning_field_z[cell] + reservoir::input_field[cell][2];


      // update z filed with reservoir input
      /* if (reservoir::input_field[cell] != 0){
         spin_field[2] = reservoir::input_field[cell];
      }
      else {
