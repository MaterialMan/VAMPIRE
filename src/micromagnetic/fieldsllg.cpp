...
namespace micromagnetic{
   ...
   namespace internal{
      ...
      spin_field[2] =ext_field[2] + exchange_field[2] - one_o_chi_perp[cell]*m[2]*m_e[cell]*ku_z[cell]  + sigma_para*mtrandom::gaussian() + pinning_field_z[cell] + reservoir::input_field[cell];
