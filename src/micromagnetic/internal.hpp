...
// all three dimensions
 extern std::vector <std::vector <double>> input_field;
  ...
  // all three dimensions
  extern std::vector <std::vector <double>> output_mag;

  void read_field(); // reads data from reservoir input file

  void update_field(); // updates the values of input_field at each timestep
