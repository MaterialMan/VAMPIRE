...
//std::cout << "a" <<std::endl;
      ...
      for (int cell = 0; cell < num_cells; cell++){
         ...
         //reservoir::output_mag[cell] = z; // Z-direction only
         reservoir::output_mag[cell][0] = x;
         reservoir::output_mag[cell][1] = y;
         reservoir::output_mag[cell][2] = z;
